...
import { ArrowLeft, FileText, FileUp, Mic, Camera, Upload, Play, Square, Image, Loader2, Sparkles } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col pb-24">
        <div className="p-6 space-y-6 flex-1 flex flex-col">
          ...
          <GlassCard className="p-8 flex-1 flex flex-col items-center justify-center">
            ...
            <h3 className="text-white mb-2">Capture Image</h3>
            <p className="text-white/60 mb-6 text-center">
              Take a photo of notes, whiteboards, or documents
            </p>
          </GlassCard>
